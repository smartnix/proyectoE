 ...
 */
final class Version20190619220010 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tipo_de_identificacion ADD id INT AUTO_INCREMENT NOT NULL, CHANGE TIPO_ID tipo_id INT NOT NULL, CHANGE DESCRICION descricion VARCHAR(45) NOT NULL, ADD PRIMARY KEY (id)');
